...
| M3 L11    | 已完成 | 已完成 | 已完成 | 已完成 | 已完成 | 已完成   | 静态UI | 不适用 | 不适用 | 不适用 |
| M4 L16    | 已完成 | 已完成 | 已完成 | 已完成 | 已完成 | 已完成   | 静态UI | 静态UI | 不适用 | 不适用 |
| M5 DIRECT | 已完成 | 已完成 | 已完成 | 已完成 | 已完成 | 已完成   | 静态UI | 静态UI | 静态UI | 不适用 |
| M6 HALF   | 已完成 | 已完成 | 已完成 | 已完成 | 已完成 | 已完成   | 静态UI | 静态UI | 静态UI | 静态UI |
