...
> **Live Demo:** https://laipeng101.github.io/pmbus-calculator/ (currently deploys `v1.1.9`)
>
> **Stable version:** [`v1.1.9`](https://github.com/laipeng101/pmbus-calculator/releases/tag/v1.1.9) · [Releases](https://github.com/laipeng101/pmbus-calculator/releases) · [SHA256SUMS.txt](https://github.com/laipeng101/pmbus-calculator/releases/download/v1.1.9/SHA256SUMS.txt)
...
**Production deployment:** the official site at https://laipeng101.github.io/pmbus-calculator/ deploys the immutable `v1.1.9` Release asset. See [docs/DEPLOYING.md](docs/DEPLOYING.md).
