...
>
> **Live Demo:** https://laipeng101.github.io/pmbus-calculator/ (currently deploys `v2.6.7`)
>
> **Stable version:** [`v2.6.7`](https://github.com/laipeng101/pmbus-calculator/releases/tag/v2.6.7) · [Releases](https://github.com/laipeng101/pmbus-calculator/releases) · [SHA256SUMS.txt](https://github.com/laipeng101/pmbus-calculator/releases/download/v2.6.7/SHA256SUMS.txt)
...
**Production deployment:** the official site at https://laipeng101.github.io/pmbus-calculator/ deploys the immutable `v2.6.7` Release asset. See [docs/DEPLOYING.md](docs/DEPLOYING.md).
