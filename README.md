...
>
> **Live Demo:** https://laipeng101.github.io/pmbus-calculator/ (currently deploys `v2.5.1`)
>
> **Stable version:** [`v2.5.1`](https://github.com/laipeng101/pmbus-calculator/releases/tag/v2.5.1) · [Releases](https://github.com/laipeng101/pmbus-calculator/releases) · [SHA256SUMS.txt](https://github.com/laipeng101/pmbus-calculator/releases/download/v2.5.1/SHA256SUMS.txt)
...
**Production deployment:** the official site at https://laipeng101.github.io/pmbus-calculator/ deploys the immutable `v2.5.1` Release asset. See [docs/DEPLOYING.md](docs/DEPLOYING.md).
