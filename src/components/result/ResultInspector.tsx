  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="result-value-tile mb-4 min-w-0 overflow-hidden rounded-xl px-4 py-5 text-center md:px-6 md:py-6 panel-surface-muted"
      >
        ...
        <div className="result-formula mt-1">
          {vm.formulaDetailLines.length > 0 ? (
            <div className="space-y-1.5">
              {vm.formulaDetailLines.map((line, index) =>
                line.kind === 'summary' ? (
                  ...
                  <div
                    key={`${line.kind}-${index}`}
                    className="math-scroll flex justify-center text-sm font-medium color-text-secondary"
            ...
            <div className="math-scroll flex justify-center text-sm font-medium color-text-secondary">
      ...
      <div className="mb-3 min-w-0">
        ...
        <div className="input-surface rounded-lg px-4 py-2 text-lg font-semibold">{vm.rawHex}</div>
      </div>
