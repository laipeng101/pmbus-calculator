...
- v2.6.4（PATCH）：relative ULINEAR16 R=0 非符合性告警（§8.5.2，单一来源
  `resolveL16Relative`，数学精确 0 不伪造饱和；区分 nominal=0 真零与 signed
  offset，缺标称仍告警）；DIRECT generic signed §7.4 契约澄清（页面/README/
