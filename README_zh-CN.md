...
> **Live Demo：** https://laipeng101.github.io/pmbus-calculator/ （当前部署版本 `v1.1.0`）
>
...
| **IEEE 半精度**     | IEEE 754 binary16（1 位符号、5 位指数、10 位尾数） | $X = \operatorname{decodeHalf}\left(\mathrm{raw}\right)$ |
...
**正式部署：** 官方站点 https://laipeng101.github.io/pmbus-calculator/ 部署的是不可变的 `v1.1.0` Release 资产。见 [docs/DEPLOYING.md](docs/DEPLOYING.md)。
