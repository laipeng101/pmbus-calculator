...
> **Live Demo：** https://laipeng101.github.io/pmbus-calculator/ （当前部署版本 `v1.1.10`）
>
...
| **LINEAR16 (VOUT)** | 16 位无符号尾数，指数来自 `VOUT_MODE`              | $X = V \times 2^N$                                                        |
...
**正式部署：** 官方站点 https://laipeng101.github.io/pmbus-calculator/ 部署的是不可变的 `v1.1.10` Release 资产。见 [docs/DEPLOYING.md](docs/DEPLOYING.md)。
