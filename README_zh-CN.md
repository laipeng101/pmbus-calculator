...
>
> **Live Demo：** https://laipeng101.github.io/pmbus-calculator/ （当前部署版本 `v2.4.0`）
>
...
**正式部署：** 官方站点 https://laipeng101.github.io/pmbus-calculator/ 部署的是不可变的 `v2.4.0` Release 资产。见 [docs/DEPLOYING.md](docs/DEPLOYING.md)。
