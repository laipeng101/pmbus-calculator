...
> **Live Demo：** https://laipeng101.github.io/pmbus-calculator/ （当前部署版本 `v1.1.5`）
>
> **Stable version：** [`v1.1.5`](https://github.com/laipeng101/pmbus-calculator/releases/tag/v1.1.5) · [Releases](https://github.com/laipeng101/pmbus-calculator/releases) · [SHA256SUMS.txt](https://github.com/laipeng101/pmbus-calculator/releases/download/v1.1.5/SHA256SUMS.txt)
...
**正式部署：** 官方站点 https://laipeng101.github.io/pmbus-calculator/ 部署的是不可变的 `v1.1.5` Release 资产。见 [docs/DEPLOYING.md](docs/DEPLOYING.md)。
